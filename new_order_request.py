...
order_data = {'type': 1, 'user_id': 84444, 'product_id' : 'INFY', 'side': 1, 'price_instruction':'LIMIT', 'ask_price': 75, 'total_qty' : 30, 'client': 1, 'exchange_id': 'BSE', 'account': 01, 'counter_party': 'C1'}
